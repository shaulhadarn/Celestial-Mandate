...
import { gameState, events, startResearch, cancelResearch, TECH_TREE, getAvailableTechs, getTechById } from '../core/state.js';
...
function renderResearchPanel() {
    ...
    tiers.forEach(tier => {
        ...
        html += `<div class="research-tier-section">`;
        ...
        tierTechs.forEach(tech => {
            ...
            const available = prereqsMet && !completed && !isActive;
            ...
            html += `
                <div class="${cardClass}" data-tech-id="${tech.id}">
                    ...
                    <div class="research-card-footer">
                        ...
                        ${locked ? `<span class="research-card-status locked-txt">🔒 Locked</span>` : ''}
