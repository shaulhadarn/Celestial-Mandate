/* Updated: Split into Step 4 (Archetype + Ethics) and Step 5 (Civics) with animated SVGs */
...
const ARCHETYPE_SVGS = {
    ...
    machine:    `<svg viewBox="0 0 60 60" fill="none" class="arch-svg"><rect x="8" y="20" width="44" height="20" rx="3" stroke="currentColor" stroke-width="2" fill="none" class="arch-svg-body"/><rect x="20" y="8" width="20" height="12" rx="2" stroke="currentColor" stroke-width="1.5" fill="none" class="arch-svg-head"/><rect x="20" y="40" width="20" height="12" rx="2" stroke="currentColor" stroke-width="1.5" fill="none" class="arch-svg-feet"/><circle cx="22" cy="30" r="3" fill="currentColor" class="arch-svg-eye"/><circle cx="38" cy="30" r="3" fill="currentColor" class="arch-svg-eye"/><line x1="25" y1="30" x2="35" y2="30" stroke="currentColor" stroke-width="1.5" class="arch-svg-mouth"/></svg>`,
